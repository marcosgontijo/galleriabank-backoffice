...
/**
 * This class read the 'sysconf.properties' configuration file and loads the paths into memory. Other modules/applications
 * can access the PropertyLoader to get the path of the configuration files.
 * @author walterwong
 */
public final class PropertyLoader {
    ...
    /**
     * This method gets the property given by the name and returns it if present, otherwise, it returns an empty string.
    ...
    /**
     * Returns a property value as boolean. Will return false if the property is not found.
     * @param propertyName The property name to retrieve.
     * @return the boolean value of the property.
     */
    ...
    /**
     * Returns a property value as String. Will return null if the property is not found.
     * @param propertyName The property name to retrieve.
     * @return the String value of the property.
     */
