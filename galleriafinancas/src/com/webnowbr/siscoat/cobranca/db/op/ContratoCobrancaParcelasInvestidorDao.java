...
public class ContratoCobrancaParcelasInvestidorDao extends HibernateDao <ContratoCobrancaParcelasInvestidor,Long> {
	...
	private static final String QUERY_GET_PARCELAS_POR_DATA =  	"select id idparcela, numerocontrato, recebedor, pagador, recebedorenvelope, empresa, recebedorgarantido, datavencimento, baixado, valorFace, saldoCredor from (" + 
			" select cp.id, c.numerocontrato, c.recebedor recebedor, c.pagador pagador, c.recebedorenvelope recebedorenvelope, empresa, c.recebedorgarantido1 recebedorgarantido, cp.datavencimento datavencimento, cp.baixado baixado, c.vlrInvestidor1 valorFace, cp.saldoCredorAtualizado saldoCredor from cobranca.contratocobranca_parcelas_investidor_join_1 cj" + 
			...
			"union" + 
			"  select cp.id, c.numerocontrato, c.recebedor2 recebedor, c.pagador pagador, c.recebedorenvelope2 recebedorenvelope, empresa, c.recebedorgarantido2 recebedorgarantido, cp.datavencimento datavencimento, cp.baixado baixado, c.vlrInvestidor2 valorFace, cp.saldoCredorAtualizado saldoCredor from cobranca.contratocobranca_parcelas_investidor_join_2 cj" + 
			...
			" union" + 
			"  select cp.id, c.numerocontrato, c.recebedor4 recebedor, c.pagador pagador, c.recebedorenvelope4 recebedorenvelope, empresa, c.recebedorgarantido4 recebedorgarantido, cp.datavencimento datavencimento, cp.baixado baixado, c.vlrInvestidor4 valorFace, cp.saldoCredorAtualizado saldoCredor from cobranca.contratocobranca_parcelas_investidor_join_4 cj" + 
			...
			" union" + 
			"  select cp.id, c.numerocontrato, c.recebedor5 recebedor, c.pagador pagador, c.recebedorenvelope5 recebedorenvelope, empresa, c.recebedorgarantido5 recebedorgarantido, cp.datavencimento datavencimento, cp.baixado baixado, c.vlrInvestidor5 valorFace, cp.saldoCredorAtualizado saldoCredor from cobranca.contratocobranca_parcelas_investidor_join_5 cj" + 
			...
			"  union" + 
			"  select cp.id, c.numerocontrato, c.recebedor6 recebedor, c.pagador pagador, c.recebedorenvelope6 recebedorenvelope, empresa, c.recebedorgarantido6 recebedorgarantido, cp.datavencimento datavencimento, cp.baixado baixado, c.vlrInvestidor6 valorFace, cp.saldoCredorAtualizado saldoCredor from cobranca.contratocobranca_parcelas_investidor_join_6 cj" + 
			...
			"  union" + 
			"  select cp.id, c.numerocontrato, c.recebedor8 recebedor, c.pagador pagador, c.recebedorenvelope8 recebedorenvelope, empresa, c.recebedorgarantido8 recebedorgarantido, cp.datavencimento datavencimento, cp.baixado baixado, c.vlrInvestidor8 valorFace, cp.saldoCredorAtualizado saldoCredor from cobranca.contratocobranca_parcelas_investidor_join_8 cj" + 
			...
			"  union" + 
			"  select cp.id, c.numerocontrato, c.recebedor9 recebedor, c.pagador pagador, c.recebedorenvelope9 recebedorenvelope, empresa, c.recebedorgarantido9 recebedorgarantido, cp.datavencimento datavencimento, cp.baixado baixado, c.vlrInvestidor9 valorFace, cp.saldoCredorAtualizado saldoCredor from cobranca.contratocobranca_parcelas_investidor_join_9 cj" + 
			...
			"  union" + 
			"  select cp.id, c.numerocontrato, c.recebedor10 recebedor, c.pagador pagador, c.recebedorenvelope10 recebedorenvelope, empresa, c.recebedorgarantido10 recebedorgarantido, cp.datavencimento datavencimento, cp.baixado baixado, c.vlrInvestidor10 valorFace, cp.saldoCredorAtualizado saldoCredor from cobranca.contratocobranca_parcelas_investidor_join_10 cj" + 
