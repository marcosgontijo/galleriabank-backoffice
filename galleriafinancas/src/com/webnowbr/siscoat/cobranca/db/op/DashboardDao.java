...
public class DashboardDao extends HibernateDao <Dashboard,Long> {
	...
	private static final String QUERY_DASH_CONTRATOS =  " select "
			...
			+ "		and cast(inicioanalisedata as date) >=  cast(? ::timestamp as date) "
			+ "		and cast(inicioanalisedata as date) <=  cast(? ::timestamp as date) "
			+ "	group by "
			+ "		r.id, "
			+ "		r.nome, "
	...
	private static final String QUERY_DASH_CONTRATOS_POR_STATUS =  	" select "
			...
			+ "	where c.numerocontrato is not null and"
			+ "		c.pagtolaudoconfirmada = 'true' "
			+ "		and cast(pagtoLaudoConfirmadaData as date)  >= cast(? ::timestamp as date) "
			+ "		and cast(pagtoLaudoConfirmadaData as date)  <= cast(? ::timestamp as date) "
			+ "	group by "
			+ "		r.id, "
			+ "		r.nome, "
			...
			+ "	where c.numerocontrato is not null and"
			+ "		c.AgAssinatura = 'false' "
			+ "		and cast(AgAssinaturaData as date)  >= cast(? ::timestamp as date) "
			+ "		and cast(AgAssinaturaData as date)  <= cast(? ::timestamp as date) "
			+ "	group by "
			+ "		r.id, "
			+ "		r.nome, "
			...
			+ "	where c.numerocontrato is not null and"
			+ "		c.status = 'Aprovado' "
			+ "		and cast(agRegistroData as date)  >= cast(? ::timestamp as date) "
			+ "		and cast(agRegistroData as date)  <= cast(? ::timestamp as date) "
			+ "	group by "
			+ "		r.id, "
			+ "		r.nome, "
			...
			+ "	where c.numerocontrato is not null and"
			+ "		c.aprovadoComite = 'true' "
			+ "		and cast(aprovadoComiteData as date)  >= cast(? ::timestamp as date) "
			+ "		and cast(aprovadoComiteData as date)  <= cast(? ::timestamp as date) "
			+ "	group by "
			+ "		r.id, "
			+ "		r.nome, "
	...
	private static final String QUERY_DASH_CONTRATOS_LEADS = "select\r\n"
			...
			+ "		and cast(c.dataContrato as date)  >= cast(? ::timestamp as date)\r\n"
			+ "		and cast(c.dataContrato as date)  <= cast(? ::timestamp as date)\r\n"
			+ "	group by\r\n"
			+ "		c.urllead,\r\n"
			+ "		c.datacontrato\r\n"
			...
			+ "		and c.contratolead\r\n"
			+ "		and cast(dataContrato as date)  >= cast(? ::timestamp as date)\r\n"
			+ "		and cast(dataContrato as date)  <= cast(? ::timestamp as date)\r\n"
			+ "	group by\r\n"
			+ "		c.urllead,\r\n"
			+ "		c.datacontrato\r\n"
			...
			+ "		and c.contratolead\r\n"
			+ "		and cast(leadCompletoData as date)  >= cast(? ::timestamp as date)\r\n"
			+ "		and cast(leadCompletoData as date)  <= cast(? ::timestamp as date)\r\n"
			+ "	group by\r\n"
			+ "		c.urllead,\r\n"
			+ "		c.datacontrato\r\n"
	...
	private static final String QUERY_DASH_CONTRATOS_LEADS_POR_STATUS = "select\r\n"
			...
			+ "		and c.statuslead = 'Em Tratamento'\r\n"
			+ "		and c.contratolead\r\n"
			+ "		and cast(LeadEmTratamentoData as date)  >= cast(? ::timestamp as date)\r\n"
			+ "		and cast(LeadEmTratamentoData as date)  <= cast(? ::timestamp as date)\r\n"
			+ "	group by\r\n"
			+ "		c.urllead,\r\n"
			+ "		c.datacontrato\r\n"
			...
			+ "		and c.statuslead = 'Ag. Contato'\r\n"
			+ "		and c.contratolead\r\n"
			+ "		and cast(c.leadAgContatoData as date)  >= cast(? ::timestamp as date)\r\n"
			+ "		and cast(c.leadAgContatoData as date)  <= cast(? ::timestamp as date)\r\n"
			+ "	group by\r\n"
			+ "		c.urllead,\r\n"
			+ "		c.datacontrato\r\n"
			...
			+ "		and c.statuslead = 'Ag. Doc.'\r\n"
			+ "		and c.contratolead\r\n"
			+ "		and cast(c.leadAgDocData as date)  >= cast(? ::timestamp as date)\r\n"
			+ "		and cast(c.leadAgDocData as date)  <= cast(? ::timestamp as date)\r\n"
			+ "	group by\r\n"
			+ "		c.urllead,\r\n"
			+ "		c.datacontrato\r\n"
			...
			+ "		and c.statuslead = 'Reprovado'\r\n"
			+ "		and c.contratolead\r\n"
			+ "		and cast(LeadReprovadoData as date)  >= cast(? ::timestamp as date)\r\n"
			+ "		and cast(LeadReprovadoData as date)  <= cast(? ::timestamp as date)\r\n"
			+ "	group by\r\n"
			+ "		c.urllead,\r\n"
			+ "		c.datacontrato\r\n"
			...
			+ "		and c.cadastroaprovadovalor = 'Aprovado'\r\n"
			+ "		and c.contratolead\r\n"
			+ "		and cast(CadastroAprovadoData as date)  >= cast(? ::timestamp as date)\r\n"
			+ "		and cast(CadastroAprovadoData as date)  <= cast(? ::timestamp as date)\r\n"
			+ "	group by\r\n"
			+ "		c.urllead,\r\n"
			+ "		c.datacontrato\r\n"
