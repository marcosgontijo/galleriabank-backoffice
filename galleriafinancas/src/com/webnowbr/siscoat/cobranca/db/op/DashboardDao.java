...
public class DashboardDao extends HibernateDao <Dashboard,Long> {
	...
	private static final String QUERY_DASH_CONTRATOS_POR_STATUS =  	" select "
			...
			+ "	where c.numerocontrato is not null and"
			+ "		c.statuslead = 'Completo' "
			+ "		and cast (inicioanalisedata as date) >= ? ::timestamp "
			+ "		and cast (inicioanalisedata as date) <= ? ::timestamp "
			+ "	group by "
			+ "		r.id, "
			+ "		r.nome, "
			...
			+ "	where c.numerocontrato is not null and"
			+ "		c.pagtolaudoconfirmada = 'true' "
			+ "		and cast (pagtoLaudoConfirmadaData as date) >= ? ::timestamp "
			+ "		and cast (pagtoLaudoConfirmadaData as date) <= ? ::timestamp "
			+ "	group by "
			+ "		r.id, "
			+ "		r.nome, "
			...
			+ "	where c.numerocontrato is not null and"
			+ "		c.AgAssinatura = 'false' "
			+ "		and cast (AgAssinaturaData as date) >= ? ::timestamp "
			+ "		and cast (AgAssinaturaData as date) <= ? ::timestamp "
			+ "	group by "
			+ "		r.id, "
			+ "		r.nome, "
			...
			+ "	where c.numerocontrato is not null and"
			+ "		c.status = 'Aprovado' "
			+ "		and cast (agRegistroData as date) >= ? ::timestamp "
			+ "		and cast (agRegistroData as date) <= ? ::timestamp "
			+ "	group by "
			+ "		r.id, "
			+ "		r.nome, "
			...
			+ "	where c.numerocontrato is not null and"
			+ "		c.aprovadoComite = 'true' "
			+ "		and cast (aprovadoComiteData as date) >= ? ::timestamp "
			+ "		and cast (aprovadoComiteData as date) <= ? ::timestamp "
			+ "	group by "
			+ "		r.id, "
			+ "		r.nome, "
