...
public class SeguradoDAO extends HibernateDao <Segurado,Long> {
	...
	private static final String QUERY_SEGURDOS_DFI = "select coco.numerocontrato,  datacontrato, numerocontratoseguro, valorimovel, pare.cpf, pare.cnpj, pare.nome, segu.porcentagemsegurador, " +
	...
	private static final String QUERY_SEGURDOS_MIP = "select coco.numerocontrato,  datacontrato, numerocontratoseguro, sum(ccd.vlrparcela) saldodevedor, pare.cpf, pare.cnpj, pare.nome, \r\n"
			...
			+ "group by coco.numerocontrato,  datacontrato, numerocontratoseguro, pare.cpf, pare.cnpj, pare.nome, segu.porcentagemsegurador,\r\n"
			+ "coco.qtdeparcelas, pare.endereco, pare.numero, pare.complemento, pare.bairro, pare.cidade, pare.estado, pare.cep, \r\n"
